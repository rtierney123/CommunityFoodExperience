...
public static class Status
{
    ...
    //STORE
    public static string repeatedWIC = "There are multiple {0} items. " +
    ...
    public static string carBrokeDown = "Your car has broken down and you must get it fixed (will be repaired in 3 hours).";
